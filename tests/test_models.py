...
class TestAgentStep:
    ...
    def test_create_step(self):
        ...
        step = AgentStep(
            ...
            tool_calls=[
                ToolCall(id="call_1", tool_name="test", parameters={})
            ]
        )
...
class TestAgentResponse:
    ...
    def test_response_thought_validation(self):
        ...
        response2 = AgentResponse(
            thought=AgentThought(content="Test thought"),
            final_answer="Answer"
        )
...
class TestStreamingModels:
    ...
    def test_streaming_event_types(self):
        ...
        plan_event = AgentPlanEvent(
            plan=AgentPlan(thought="test", plan=["step1"])
        )
        ...
        step_event = AgentStepEvent(
            step=AgentStep(
                thought="test",
                tool_calls=[ToolCall(id="1", tool_name="test")]
            )
        )
